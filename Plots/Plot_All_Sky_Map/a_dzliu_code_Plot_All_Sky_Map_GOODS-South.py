...
if __name__ == "__main__":
    ...
    ax.annotate('GOODS-South (enlarged)', xy=(0.001, 1.001), color='#000000', ha='left', va='bottom', xycoords=ax.transAxes, zorder=10, fontsize=18, fontweight='bold')
    plt.subplots_adjust(left=0.1, bottom=0.1, right=0.9, top=0.9)
    fig.savefig('Plot_All_Sky_Map_GOODS-South.pdf')
    #plt.show(block=True)
    
    
    
    hdu = fits.open('photos/GOODSS_Photos/s_mips_1_s1_v0.30_sci.null.fits.gz')[0]
    wcs = WCS(hdu.header)
    ...
    ax2.invert_xaxis()
    ax2.annotate('GOODS-South', xy=(0.01, 0.99), color='#000000', ha='left', va='top', xycoords=ax2.transAxes, zorder=10, fontsize=15, fontweight='bold')
    ...
    fig2.savefig('Plot_Field_GOODS-South.pdf')
    #plt.show(block=True)
