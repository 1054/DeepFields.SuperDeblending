...
topcat -stilts plot2plane \
                ...
                ifmt1=ascii \
                icmd1="select \"(SNR_IR>=5 && goodArea==1)\"" \
                ...
                ifmt2=ascii \
                icmd2="select \"(SNR_IR>=5 && goodArea==1)\"" \
                ...
                aspect=1.0 \
                omode=out \
                out='Plot_comparison_SFR_UV_and_IR_goodArea.pdf'
...
open "Plot_comparison_SFR_UV_and_IR_goodArea.pdf"
