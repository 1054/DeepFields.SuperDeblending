; 
; Actually just a function version of CrabImageHistogram
; 
FUNCTION CrabImageHist, InputArray, LOCATIONS=ZCent, NORMALIZE=NORMALIZE, NBINS=NBINS, MIN=ZMin, MAX=ZMax, MEAN=ZMean, SIGMA=ZSigma, Clip=doClip, Plot=doPlot
