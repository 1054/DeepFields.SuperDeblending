...
; ###################################### ;
;                                        ;
; Main Program -- AstroDepthFaireMontage ;
;                                        ;
; ###################################### ;
; ###################################### ;

PRO AstroDepthFaireMontage, PriorCatalog, SelectID, PhotoList, RegionList, SaveEPS=SaveEPS, Verbose=Verbose, RA=RA, Dec=Dec, ForceOneRow=ForceOneRow, ForceOneRadius=ForceOneRadius, WithTextCharSize=TextCharSize, WithTextCharThick=TextCharThick, WithCircleThicks=CircleThicks, PowerLawScale=PowerLawScale
