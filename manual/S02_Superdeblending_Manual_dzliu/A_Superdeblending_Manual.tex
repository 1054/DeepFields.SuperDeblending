...
\subsection{SED prediction bias}
...
\subsection{Galfit zero error issue}
...
\subsection{SED prediction and prior source selection issue}
...
Do we apply this criterion when selecting prior sources to fit: if a source has more than $3\sigma$ detection at previous FIR band (i.e. $24{\mu}m$ to $1160{\mu}m$), then we fit it at current band, ignoring its SED flux criterion? ---- Yes. 



\subsection{GN20 GN20.2a GN20.2b source position issue}

\textcolor{green!90!black!60!orange}{Date: 2016-01-07}

GN20.2a is actually corresponding to 2 HST sources. Therefore we TODO
